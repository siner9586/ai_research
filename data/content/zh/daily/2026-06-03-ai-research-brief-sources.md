...
summary: "内部生成元数据：本期候选论文 273 篇，独立历史期恢复。"
tags: ["internal"]
topics: ["internal"]
...
本页为 2026-06-03 独立历史期 sources。数据源采用 2026-06-01 的真实 arXiv 候选池，不调用、不复用 2026-06-09 最新一期内容。
...
- [KForge: LLM-Driven Cross-Platform Kernel Generation for AI Accelerators](https://arxiv.org/abs/2606.02963)
